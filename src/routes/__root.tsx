...
function NotFoundComponent() {
  return (
    <div className="flex min-h-dvh md:min-h-screen items-center justify-center bg-background px-4">
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "ZENNO CRM AI",
          url: "https://zenno-connect-ai.lovable.app",
          description: "Plataforma SaaS multiempresa de CRM com WhatsApp, Meta Ads, Google Ads, automações e IA.",
        }),
      },
    ],
  }),
